...
- Access Secret: `YOUR_ACRCLOUD_SECRET_KEY`
- Host: `identify-eu-west-1.acrcloud.com` (or similar)

**In the App (ShazamService.java):**
```java
private static final String ACRCLOUD_ACCESS_KEY = "YOUR_ACRCLOUD_ACCESS_KEY";
private static final String ACRCLOUD_SECRET_KEY = "YOUR_ACRCLOUD_SECRET_KEY";
```
