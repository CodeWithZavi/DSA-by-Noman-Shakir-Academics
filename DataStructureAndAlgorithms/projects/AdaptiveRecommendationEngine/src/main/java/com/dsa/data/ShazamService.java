...
public class ShazamService {
    ...
    private static final String ACRCLOUD_ACCESS_KEY = env("ACRCLOUD_ACCESS_KEY");
    private static final String ACRCLOUD_SECRET_KEY = env("ACRCLOUD_SECRET_KEY");
    private static final String AUDD_API_TOKEN = env("AUDD_API_TOKEN");
    ...
    private Track tryACRCloudHost(String host, byte[] audioData) throws Exception {
        if (ACRCLOUD_ACCESS_KEY.isBlank() || ACRCLOUD_SECRET_KEY.isBlank()) {
            throw new IllegalStateException("Set ACRCLOUD_ACCESS_KEY and ACRCLOUD_SECRET_KEY before using ACRCloud.");
        }
